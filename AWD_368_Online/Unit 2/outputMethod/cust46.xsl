...
<xsl:value-of select="format-number(payment_date/month, '00', 'dateMonthDay')" />
<xsl:value-of select="format-number(payment_date/day, '00', 'dateMonthDay')" />
<xsl:value-of select="format-number(payment_date/year, '0000', 'dateYear')" />
