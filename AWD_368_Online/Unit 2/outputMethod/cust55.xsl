...
<xsl:output method="xml" version="1.0" indent="yes" encoding="iso-8859-1" standalone="no" cdata-section-elements="shippingUnit orderNumber"/>
<xsl:template match="/">
<xsl:processing-instruction name="xml-stylesheet">type="text/xsl" href="cust55html.xsl"</xsl:processing-instruction>
